...
java -ea -cp "$CLASSPATH_VALUE" \
  ...
  "$ROOT/src/test/resources/external-golden-cases/advertising-model-feature-set.json" \
  "$ROOT/src/test/resources/external-golden-cases/advertising-offline-cases.json"
